import { EncodeBase64, QuickHash, Serialize } from "../../core/Core";
import { AbstractAction, AbstractServiceAdapter, ActionStdioType, IServiceAdapter } from "./AbstractAction";

const { spawn, fork, exec, execSync } = require('child_process');

export class SpawnService extends AbstractServiceAdapter implements IServiceAdapter {
